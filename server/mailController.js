...
export async function enviarCorreoDeRegistro(email, verifyUrl) {
            ...
            <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color:#ffffff; border-radius:8px; overflow:hidden;">
              ...
              <tr>
                <td style="padding:24px; font-family:Arial, sans-serif; font-size:16px; color:#333333;">
                  ...
                  <p style="margin:0 0 12px;">Bienvenido a Brible, por favor confirma tu correo electrónico para acceder a todos los beneficios.</p>
